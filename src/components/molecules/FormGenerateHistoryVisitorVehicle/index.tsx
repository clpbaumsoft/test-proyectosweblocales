...
import useFormGenerateHistoryVisitorVehicle from "./useFormGenerateHistoryVisitorVehicle";
...
const TRANS = {
  ...
  generateReport: {
	...
	table_full_name_leave: {
    id: "GenerateHistoryVehicleDashboard.Table.FullNameLeave",
    defaultMessage: "Quién dió salida",
    description: "",
  },
...
export default function FormGenerateHistoryVisitorVehicle() {
							...
							<Table stickyHeader sx={{ minWidth: 1200 }} aria-label="vehicle history table">
								<TableHead>
									<TableRow>
										...
										<TableCell sx={{ fontWeight: 'bold', minWidth: 150 }}>{TEXTS.table_full_name_leave}</TableCell>
									...
									{historyData
										...
										.map((item, index) => (
											...
											>
												...
												<TableCell>{item.fullname_leave || '-'}</TableCell>
