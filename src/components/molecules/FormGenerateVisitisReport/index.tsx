...
const TRANS = {
  ...
  generateReport: {
	...
	table_visit_creator: {
    id: "GenerateReportsDashboard.Table.VisitCreator",
					...
					<Table stickyHeader sx={{ minWidth: 1200 }} aria-label="visits table">
						<TableHead>
							<TableRow>
								...
								<TableCell sx={{ fontWeight: 'bold', minWidth: 150 }}>{TEXTS.table_visit_creator}</TableCell>
						...
						<TableBody>
							{visitsData.map((visit, index) => (
									...
									>
										...
										<TableCell>{visit.visit_creator_name || '-'}</TableCell>
